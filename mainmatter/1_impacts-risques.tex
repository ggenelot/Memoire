...
\begin{figure}
    ...
    \legende{Trajectoires présentées dans le rapport de synthèse du \Gls{GIEC}}{Les rapports du \Gls{GIEC} présentent des trajectoires. Celles-ci sont obtenues à l'aide de modèles.}
