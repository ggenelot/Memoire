...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{results/carte_fund.png} % Remplacez par le chemin de votre image
        \subcaption{FUND}
...
\begin{authoredquote}[\autocite{anthoff_fund_nodate}]
...
\begin{authoredquote}[\textcite{aykut_gouverner_2015}, p.19]
