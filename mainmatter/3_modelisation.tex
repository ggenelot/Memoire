...
\displayquote[Gabriel]{Le changement climatique est un défi majeur qui nécessite une action immédiate pour atténuer ses effets.}
...
\begin{figure}
    ...
    \legende{Carte en anamorphose selon le niveau de dommage}{L'espace est déformé pour que la surface de chaque zone soit proportionnelle à la valeur absolue des dommages subis. On observe que la région LROW (rose) a une surface plus importante que sa surface réelle, tandis que l'UE27 et USMCA ont une surface réduite. }
...
Les résultats par région (voir table \ref{tab:reg_1}) permettent de mettre en évidence le rôle que joue chacun des trois types de variables explicatives détaillées plus haut : physique, méthodologique et éthique. 
...
\begin{figure}[h!]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{results/exponent.png} % Remplace "image1.png" par le nom de ton fichier d'image
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{results/norm_constant.png} % Remplace "image2.png" par le nom de ton fichier d'image
