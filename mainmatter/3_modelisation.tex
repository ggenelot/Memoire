...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{image1.png} % Remplace "image1.png" par le nom de ton fichier d'image
        \caption{Première sous-figure}
        \label{fig:sous-figure1}
    \end{subfigure}
    \hfill % Espace entre les deux sous-figures
    
    % Deuxième sous-figure
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{image2.png} % Remplace "image2.png" par le nom de ton fichier d'image
